...
menubar = Menu()
menubar.add_command(label="Squat", command=Squat)
menubar.add_command(label="Pushup", command=Pushup)
menubar.add_command(label="Plank", command=Plank)
menubar.add_command(label="Bicep Curl", command=BicepCurl)
